...
$query="SELECT EmailId,Password,StaffId FROM tblstaff WHERE EmailId='$username' and Password='$password'";
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="brown darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title ">DCJ_Staff_leave</span>
                        </div>
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="card-title center"><h4> Welcome </h4></div>
                              ...
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Staff Login</span>
                                       <div class="row">
                                           <form class="col s12" action="" name="signin" method="post">
